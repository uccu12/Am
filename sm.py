...
\033[1;37m║  ╚═════╝░░░░╚═╝░░░╚═╝░░╚═╝  ░░░░░░ ░░░╚═╝░░░░╚════╝░░╚════╝░╚══════╝║
\033[1;37m╠═════════════════════════════════════════════════════════════════════╣
\033[1;32m║➢ Tool By    :          DTH - Tool                                   ║
\033[1;36m║➢ Youtube  : https://youtube.com/@DTHTOOL                            ║
\033[1;31m║➣ Box Hỗ Trợ : https://t.me/+iB9b6eb69V04MGE9                        ║
\033[1;33m║➣ Website  : cocaicc                                                 ║
\033[1;37m╚═════════════════════════════════════════════════════════════════════╝
"""
for X in banner:
  sys.stdout.write(X)
...
if __name__ == "__main__":
    ...
    luong_chay = int(input("\033[1;32mNhập số luồng chạy cùng 1 lúc: \033[1;33m "))
    delay = int(input("\033[1;32mNhập delay mỗi lần spam: \033[1;33m"))
    dem_func = 0
    for i in range(1, count + 1):
        ...
        if (len (threads_quan_li) >=luong_chay ):
            ...
            time.sleep (delay)
        print(f"\033[1;32mSpam thành công, \033[1;33m{i}")
